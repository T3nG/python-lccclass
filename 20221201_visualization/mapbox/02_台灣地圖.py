...
fig.show()
# git 為版本控制的工具, 也可以協助多人開發, 大部分的公司都會使用, 只是使用的方法對或不對而已
# 比如
# release note
# v1.0.1 : 修改fix_scatter裡的參數
# v1.0.0 : Initialization

# 如果改來改去放註解, 其實程式碼會看起來很亂, 用git去幫助版本控制
# 在 pycharm裡面啟用git, VCS=> enable